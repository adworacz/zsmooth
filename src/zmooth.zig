...
export fn VapourSynthPluginInit2(plugin: *vs.Plugin, vspapi: *const vs.PLUGINAPI) void {
    ...
    _ = vspapi.registerFunction.?("TemporalSoften2", "clip:vnode;radius:int:opt;luma_threshold:int:opt;chroma_threshold:int:opt;scenechange:int:opt;mode:int:opt;planes:int[]:opt;", "clip:vnode;", temporalSoften.temporalSoftenCreate, null, plugin);
}
